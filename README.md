...
## **STEP 2**: OCI Console 로그인
> https://console.us-ashburn-1.oraclecloud.com 접속 > Tenant 입력 > **Continue** 클릭 > oracleidentitycloudservice 선택(Default) > **Continue** 클릭 > 사용자 이름(User Name)과 암호(Password) 입력 > **Sign In** 클릭
